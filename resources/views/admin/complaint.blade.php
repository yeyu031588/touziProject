            ...
            @if (isset($data))
                ...
                @forelse($data as $val)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo URL::action('Admin\SystemController@complaintDetail',['id'=>$val['id']]);?>" class="layui-btn layui-btn-mini"><i class="iconfont icon-edit"></i> 编辑</a>
        ...
        layui.config({
                    ...
                    layer.confirm('确定删除选中的信息？',{icon:3, title:'提示信息'},function(index){
                        ...
                        setTimeout(function(){
                            ...
                            for(var j=0;j<$checked.length;j++){
                                $.post('/Admin/complaintDrop',{id:$checked[j].value},function(data){
                                    if(data.status){
            ...
            $("body").on("click",".users_del",function(){  //删除
                ...
                layer.confirm('确定删除此用户？',{icon:3, title:'提示信息'},function(index){
                    ...
                    $.post('/Admin/complaintDrop',{id:id},function(data){
                        if(data.status){
                            _this.parents("tr").remove();
                            layer.close(index);
                        }
