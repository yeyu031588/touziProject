    ...
    <form class="layui-form" id='form' style="width:80%;" onsubmit="return false;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入备注信息" readonly class="layui-textarea">{{$data['tousujianyi'] or ''}}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">联系qq</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" value="{{$data['qq']}}" readonly>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">常用E-mail</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" value="{{$data['email']}}" readonly>
            </div>
        </div>
        <div class="layui-form-item">
