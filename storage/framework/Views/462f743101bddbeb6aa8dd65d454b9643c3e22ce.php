...
<?php $__env->startSection('content'); ?>
    <blockquote class="layui-elem-quote news_search">
        <?php /*<div class="layui-inline">*/ ?>
            <?php /*<a class="layui-btn" style="background-color:#5FB878"><?php echo e($cate[$cid]); ?></a>*/ ?>
        <?php /*</div>*/ ?>
        ...
        <div class="layui-inline">
            <div class="layui-input-inline">
                ...
                <?php if(isset($cate)): ?>
                    ...
                    <?php $__empty_1 = true; foreach($cate as $key=>$val): $__empty_1 = false; ?>
                        <option value="<?php echo e($key); ?>" <?php if($cid == $key)echo 'selected';?>><?php echo e($val); ?></option>
            ...
            <?php if(isset($data)): ?>
                <?php $__empty_1 = true; foreach($data as $val): $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td align="left"><a href="<?php echo URL::action('Admin\ContentController@detail',['id'=>$val['id']]);?>"><?php echo e($val['title']); ?></a></td>
                        ...
                        <td><a href="<?php echo URL::action('Admin\ContentController@detail',['id'=>$val['id']]);?>" class="layui-btn layui-btn-mini"><i class="iconfont icon-edit"></i> 编辑</a><a class="layui-btn layui-btn-danger layui-btn-mini news_del" data-id="undefined"><i class="layui-icon"></i> 删除</a></td>
                    </tr>
                <?php endforeach; if ($__empty_1): ?>
                <?php endif; ?>
            <?php endif; ?>
