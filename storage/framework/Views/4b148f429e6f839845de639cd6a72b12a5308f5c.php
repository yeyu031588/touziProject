...
<?php $__env->startSection('content'); ?>
    ...
    <form class="layui-form" id='form' method="post" onsubmit="return false;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[guquandaima]" value="<?php echo e(isset($data['guquandaima']) ? $data['guquandaima'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">公司名称</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[mc]" value="<?php echo e(isset($data['mc']) ? $data['mc'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">公司logo</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName imgs" name="data[gslogo]" value="<?php echo e(isset($data['gslogo']) ? $data['gslogo'] : ''); ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[youzhixiangmu]" value="<?php echo e(isset($data['youzhixiangmu']) ? $data['youzhixiangmu'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">项目低价</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[djia]" value="<?php echo e(isset($data['djia']) ? $data['djia'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">锁定期限</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[rq]" value="<?php echo e(isset($data['rq']) ? $data['rq'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">注册资本</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[zczb]" value="<?php echo e(isset($data['zczb']) ? $data['zczb'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">成立时间</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[cltime]" id="form_datetime_2" value="<?php echo e(isset($data['cltime']) ? $data['cltime'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">首页缩略图</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName imgs" name="data[stu]" value="<?php echo e(isset($data['stu']) ? $data['stu'] : ''); ?>">
                <span class="up">上传</span>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[zbqs]" value="<?php echo e(isset($data['zbqs']) ? $data['zbqs'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">本次发行</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[bcfx]" value="<?php echo e(isset($data['bcfx']) ? $data['bcfx'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">剩余股数</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[cygs]" value="<?php echo e(isset($data['cygs']) ? $data['cygs'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">起头股数</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[qtgs]" value="<?php echo e(isset($data['bcrz']) ? $data['bcrz'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">本次融资</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[bcrz]" value="<?php echo e(isset($data['bcrz']) ? $data['bcrz'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">净资产</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[jingzichan]" value="<?php echo e(isset($data['jingzichan']) ? $data['jingzichan'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">总股本</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[zgb]" value="<?php echo e(isset($data['title']) ? $data['title'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">市盈率</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[shiyinglv]" value="<?php echo e(isset($data['shiyinglv']) ? $data['shiyinglv'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">每股收益</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[shouyi]" value="<?php echo e(isset($data['shouyi']) ? $data['shouyi'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">预计挂牌</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[yujiguapai]" value="<?php echo e(isset($data['yujiguapai']) ? $data['yujiguapai'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">上年净利润</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[sshouyi]" value="<?php echo e(isset($data['sshouyi']) ? $data['sshouyi'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">项目进度</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[xiangmujindu]" value="<?php echo e(isset($data['xiangmujindu']) ? $data['xiangmujindu'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">预估收益</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[yshouyi]" value="<?php echo e(isset($data['yshouyi']) ? $data['yshouyi'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">预约数</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[yy]" value="<?php echo e(isset($data['yy']) ? $data['yy'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">企业新闻</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input newsName" name="data[xgwz]" value="<?php echo e(isset($data['xgwz']) ? $data['xgwz'] : ''); ?>">
            </div>
        </div>
        <div class="layui-form-item">
