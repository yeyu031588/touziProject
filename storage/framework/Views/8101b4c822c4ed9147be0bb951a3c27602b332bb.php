            ...
            <?php if(isset($data)): ?>
                ...
                <?php $__empty_1 = true; foreach($data as $val): $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($val['pinglunneirong']); ?></td>
                        <td><?php echo e($val['cid']); ?></td>
                        <td><?php echo e($val['username']); ?></td>
                        <td><?php echo e(date('Y-m-d H:i:s',$val['time'])); ?></td>
                        <td>
                            <a href="<?php echo URL::action('Admin\CommentController@detail',['id'=>$val['id']]);?>" class="layui-btn layui-btn-mini"><i class="iconfont icon-edit"></i> 编辑</a>
        ...
        layui.config({
                    ...
                    layer.confirm('确定删除选中的信息？',{icon:3, title:'提示信息'},function(index){
                        ...
                        setTimeout(function(){
                            ...
                            for(var j=0;j<$checked.length;j++){
                                $.post('/Admin/comment/drop',{id:$checked[j].value},function(data){
                                    if(data.status){
            ...
            $("body").on("click",".users_del",function(){  //删除
                ...
                layer.confirm('确定删除此用户？',{icon:3, title:'提示信息'},function(index){
                    ...
                    $.post('/Admin/comment/drop',{id:id},function(data){
                        if(data.status){
                            _this.parents("tr").remove();
                            layer.close(index);
                        }
