...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:;">
                        ...
                        <cite><?php echo e(Session::get('admin_name')); ?></cite>
                    </a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName"><?php echo e(Session::get('admin_name')); ?></span>, 欢迎登录 </p>
        </div>
        <div class="navBar layui-side-scroll">
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item"><a href="javascript:;" ><i class="layui-icon">&#xe623;</i><cite>预约评论</cite></a>
                    <dl class="layui-nav-child">
                    <dd><a href="javascript:;" data-url="<?php echo e(url('/Admin/onlineAppointment')); ?>"><cite>在线预约</cite></a></dd>
                    <dd><a href="javascript:;" data-url="<?php echo e(url('/Admin/commentList')); ?>"><cite>文章评论</cite></a></dd>
                    <dd><a href="javascript:;" data-url="<?php echo e(url('/Admin/complaint')); ?>"><cite>投诉建议</cite></a></dd>
